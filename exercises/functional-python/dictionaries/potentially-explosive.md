...
**Requirements:**
```eval_rst
- :ref:`fundamentals:An inventory is considered "potentially explosive" if it contains`
- :ref:`fundamentals:even the mention of both "fire" and "propane" in the dictionary's keys.`
- :ref:`fundamentals:The quantities of each element are irrevelant.`
- :ref:`fundamentals:`
- :ref:`fundamentals:### Hint`
- :ref:`fundamentals:`
- :ref:`fundamentals:Use `dict.keys()` for a list of the dictionary's keys. e.g.,`
- :ref:`fundamentals:`
- :ref:`fundamentals:```python`
- :ref:`fundamentals:some_dict = {"first_name": "Jeff"}`
- :ref:`fundamentals:"first_name" in some_dict.keys()  # True`
- :ref:`fundamentals:"age" in some_dict.keys()  # False`
- :ref:`fundamentals:"name" in some_dict.keys()  # False`
- :ref:`fundamentals:````
